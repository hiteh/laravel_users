                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            @if ( Auth::user()->roles()->where( 'name', 'root' )->exists() || Auth::user()->roles()->where( 'name', 'admin' )->exists() )
                                <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('users', Auth::user()->id ) }}"><i class="fas fa-user"></i>&nbsp;{{ __('app.profile') }}</a>
